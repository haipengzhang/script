# 把framework的资源移到主bundle
#!/bin/sh
#cp -R -f $BUILT_PRODUCTS_DIR/AudioPractice.framework/AudioPracticeBundle.bundle $BUILT_PRODUCTS_DIR/$CONTENTS_FOLDER_PATH/
...
then
  ...
  # compile all xcassets into main project assets
